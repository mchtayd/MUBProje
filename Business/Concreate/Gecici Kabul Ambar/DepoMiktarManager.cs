...
namespace Business.Concreate.Gecici_Kabul_Ambar
{
    public class DepoMiktarManager //: IRepository<DepoMiktar>
    {
        ...
        public DepoMiktar GetBarkodLokasyonBulAltYuklenici(string stokNo, string seriNo, string revizyon, string takipDurum, int miktar)
        {
            try
            {
                return depoMiktarDal.GetBarkodLokasyonBulAltYuklenici(stokNo, seriNo, revizyon, takipDurum, miktar);
            }
            catch (Exception)
            {
                return null;
        ...
        public DepoMiktar GetBarkodLokasyonBul2600(string stokNo, string seriNo, string revizyon, string takipDurum, int miktar)
        {
            try
            {
                return depoMiktarDal.GetBarkodLokasyonBul2600(stokNo, seriNo, revizyon, takipDurum, miktar);
            }
            catch (Exception)
            {
                return null;
        ...
        public DepoMiktar GetBarkodLokasyonBul2700(string stokNo, string seriNo, string revizyon, string takipDurum, int miktar)
        {
            try
            {
                return depoMiktarDal.GetBarkodLokasyonBul2700(stokNo, seriNo, revizyon, takipDurum, miktar);
            }
            catch (Exception)
            {
                return null;
        ...
        public DepoMiktar GetBarkodLokasyonBul3150(string stokNo, string seriNo, string revizyon, string takipDurum, int miktar)
        {
            try
            {
                return depoMiktarDal.GetBarkodLokasyonBul3150(stokNo, seriNo, revizyon, takipDurum, miktar);
            }
            catch (Exception)
            {
                return null;
