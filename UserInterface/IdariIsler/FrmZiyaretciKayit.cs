...
namespace UserInterface.IdariIsler
{
    public partial class FrmZiyaretciKayit : Form
    {
        ...
        void Personeller1()
        {
            ...
            TxtZiyaretEdilenUnvani.Clear();
            TxtZiyaretEdilenMasYeriNo.Clear();
            TxtZiyaretEdilenMasYeri.Clear();
        }
        void Personeller2()
        {
            ...
            TxtRefakatciUnvani.Clear();
            TxtRefakatciMasYeriNo.Clear();
            TxtRefakatciMasYeri.Clear();
        }
