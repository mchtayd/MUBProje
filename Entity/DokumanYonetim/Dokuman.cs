...
namespace Entity.DokumanYonetim
{
    public class Dokuman
    {
        ...
        public Dokuman(int id, string tur, string numarasi, string tanimi, string revizyon, DateTime onaytarihi, DateTime yayintarihi, string dosyayolu, string benzersiz)
        {
            this.id = id;
            this.tur = tur;
        ...
        public Dokuman(string tur, string numarasi, string tanimi, string revizyon, DateTime onaytarihi, DateTime yayintarihi, string dosyayolu, string benzersiz)
        {
            this.tur = tur;
            this.numarasi = numarasi;
            this.tanimi = tanimi;
