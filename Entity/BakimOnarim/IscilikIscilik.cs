...
namespace Entity.BakimOnarim
{
    ...
    {
        int id, benzersizId; string adSoyad, gorevi, bolum, iscilikTuru, abfSiparis; DateTime tarih; string iscilikSuresi;
        ...
        public IscilikIscilik(int id, int benzersizId, string adSoyad, string gorevi, string bolum, string iscilikTuru, string abfSiparis, DateTime tarih, string iscilikSuresi)
        {
            this.id = id;
        ...
        public IscilikIscilik(int benzersizId, string adSoyad, string gorevi, string bolum, string iscilikTuru, string abfSiparis, DateTime tarih, string iscilikSuresi)
        {
            this.benzersizId = benzersizId;
            this.adSoyad = adSoyad;
            this.gorevi = gorevi;
