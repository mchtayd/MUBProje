...
namespace Entity.STS
{
    public class SatIslemAdimlari
    {
        ...
        public SatIslemAdimlari(int id, string siparisno, string islem, string islemyapan, DateTime tarih)
        {
            this.id = id;
        ...
        public SatIslemAdimlari(string siparisno, string islem, string islemyapan, DateTime tarih)
        {
            this.siparisno = siparisno;
            this.islem = islem;
            this.islemyapan = islemyapan;
