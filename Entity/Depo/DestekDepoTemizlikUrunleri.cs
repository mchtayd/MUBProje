...
{
    public class DestekDepoTemizlikUrunleri
    {
        ...
        public DestekDepoTemizlikUrunleri(int id, string stokno, string tanim, string birim, string dosyaYolu)
        {
            this.id = id;
            this.stokno = stokno;
            this.tanim = tanim;
        ...
        public DestekDepoTemizlikUrunleri(string stokno, string tanim, string birim, string dosyaYolu)
        {
            this.stokno = stokno;
            this.tanim = tanim;
            this.birim = birim;
