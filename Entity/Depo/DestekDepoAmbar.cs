...
namespace Entity.Depo
{
    public class DestekDepoAmbar
    {
        ...
        public DestekDepoAmbar(int id, string stokno, string tanim, string birim, string dosyaYolu)
        {
            this.id = id;
            this.stokno = stokno;
            this.tanim = tanim;
        ...
        public DestekDepoAmbar(string stokno, string tanim, string birim, string dosyaYolu)
        {
            this.stokno = stokno;
            this.tanim = tanim;
            this.birim = birim;
