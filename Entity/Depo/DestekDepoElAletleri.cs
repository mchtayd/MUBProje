...
{
    public class DestekDepoElAletleri
    {
        ...
        public DestekDepoElAletleri(int id, string stokno, string tanim, string birim, string dosyaYolu)
        {
            this.id = id;
            this.stokno = stokno;
            this.tanim = tanim;
        ...
        public DestekDepoElAletleri(string stokno, string tanim, string birim, string dosyaYolu)
        {
            this.stokno = stokno;
            this.tanim = tanim;
            this.birim = birim;
