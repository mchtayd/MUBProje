...
namespace Entity
{
    ...
    {
        int sirnak, cukurca, yukseova, semdinli, derecik, dBolgesi, toplam;
        ...
        public ArizaIslemAdimi(int sirnak, int cukurca, int yukseova, int semdinli, int derecik, int dBolgesi, int toplam)
        {
            this.sirnak = sirnak;
